...
local pyenv_latest = vim.fn.glob(pyenv_root .. "/3.*", false, true)
table.sort(pyenv_latest)
if #pyenv_latest > 0 then
  vim.g.python3_host_prog = pyenv_latest[#pyenv_latest] .. "/bin/python3"
end
